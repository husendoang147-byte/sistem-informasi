...
<?php $__env->startSection('title', 'Data Pengurus'); ?>
        ...
        <div class="pengurus-header-content">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    ...
                    <a
                        href="<?php echo e(route('pengurus.create')); ?>"
        ...
        <div class="pengurus-card-header">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-success rounded-pill px-3 py-2">
                    ...
                    <?php echo e($pengurus->total()); ?> Pengurus
        ...
        <div class="table-responsive">
            ...
            <table class="table pengurus-table align-middle">
                ...
                <tbody>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $pengurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <span class="nomor">
                                    ...
                                    <?php echo e($pengurus->firstItem() + $loop->index); ?>
                            ...
                            <td>
                                ...
                                <?php if($item->foto): ?>
                                    ...
                                    <img
                                        src="<?php echo e(asset('uploads/pengurus/'.$item->foto)); ?>"
                                        class="foto-pengurus"
                            ...
                            <?php if(auth()->user()->role === 'admin'): ?>
                                ...
                                <td>
                                    ...
                                    <div class="action-wrapper">
                                        ...
                                        <a
                                            href="<?php echo e(route('pengurus.edit', $item->id)); ?>"
                                        ...
                                        <form
                                            action="<?php echo e(route('pengurus.destroy', $item->id)); ?>"
                                            method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Husen_masjid\resources\views/pengurus/index.blade.php ENDPATH**/ ?>