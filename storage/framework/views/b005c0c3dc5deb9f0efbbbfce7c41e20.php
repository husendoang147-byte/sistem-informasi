            ...
            <div class="card-body p-4">
                ...
                <div class="stat-top">
                    ...
                    <div>
                        ...
                        <div class="stat-value">
                            Rp <?php echo e(number_format($data['saldoKas'],0,',','.')); ?>
            ...
            <div class="card-body p-4">
                ...
                <div class="stat-top">
                    ...
                    <div>
                        ...
                        <div class="stat-value">
                            <?php echo e($data['totalDonasi']); ?>

                        </div>

                        <small class="text-warning">
                            Rp <?php echo e(number_format($data['totalNominalDonasi'],0,',','.')); ?>
            ...
            <div class="card-body p-4">
                ...
                <div class="stat-top">
                    ...
                    <div>
                        ...
                        <div class="stat-value">
                            <?php echo e($data['totalPengumuman']); ?>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="text-success mb-0">
                                ...
                                Rp <?php echo e(number_format($data['totalPemasukan'],0,',','.')); ?>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="text-danger mb-0">
                                ...
                                Rp <?php echo e(number_format($data['totalPengeluaran'],0,',','.')); ?>
...
<div class="row g-4 mb-4">
        ...
        <div class="card prayer-card">
            ...
            <div class="prayer-header">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('jadwal.index')); ?>" class="btn-jadwal">
    ...
    <div class="prayer-item">
        ...
        <div class="prayer-time">
            <?php echo e(\Carbon\Carbon::parse($jadwalSholat->subuh)->format('H:i')); ?>
    ...
    <div class="prayer-item">
        ...
        <div class="prayer-time">
            <?php echo e(\Carbon\Carbon::parse($jadwalSholat->dzuhur)->format('H:i')); ?>
    ...
    <div class="prayer-item">
        ...
        <div class="prayer-time">
            <?php echo e(\Carbon\Carbon::parse($jadwalSholat->ashar)->format('H:i')); ?>
    ...
    <div class="prayer-item">
        ...
        <div class="prayer-time">
            <?php echo e(\Carbon\Carbon::parse($jadwalSholat->maghrib)->format('H:i')); ?>
    ...
    <div class="prayer-item">
        ...
        <div class="prayer-time">
            <?php echo e(\Carbon\Carbon::parse($jadwalSholat->isya)->format('H:i')); ?>
...
const labels = <?php echo json_encode($label, 15, 512) ?>;
const pemasukan = <?php echo json_encode($pemasukan, 15, 512) ?>;
const pengeluaran = <?php echo json_encode($pengeluaran, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Husen_masjid\resources\views/dashboard/index.blade.php ENDPATH**/ ?>