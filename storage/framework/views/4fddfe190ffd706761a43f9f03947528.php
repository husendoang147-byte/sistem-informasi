...
<?php $__env->startSection('title', 'Kas Masjid'); ?>
        ...
        <div class="kas-hero-content">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    ...
                    <a
                        href="<?php echo e(route('kas-masjid.create')); ?>"
    ...
    <div class="kas-card">
        ...
        <div class="kas-card-header">
            ...
            <span class="total-transaksi">
                ...
                <?php echo e($kas->count()); ?> Transaksi
        ...
        <div class="table-responsive">
            ...
            <table class="table kas-table align-middle">
                ...
                <tbody>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $kas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php if(auth()->user()->role === 'admin'): ?>
                                ...
                                <td>
                                    ...
                                    <div class="kas-action">
                                        ...
                                        <a
                                            href="<?php echo e(route('kas-masjid.edit', $item->id)); ?>"
                                        ...
                                        <form
                                            action="<?php echo e(route('kas-masjid.destroy', $item->id)); ?>"
                                            method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Husen_masjid\resources\views/kas/index.blade.php ENDPATH**/ ?>