...
<?php $__env->startSection('title', 'Jadwal Imam & Khotib'); ?>
...
<div class="container-fluid px-3 px-lg-4 py-2">
    ...
    <div class="page-header mb-4">
        ...
        <?php if(auth()->user()->role === 'admin'): ?>
            <a href="<?php echo e(route('jadwal-imam.create')); ?>" class="btn-add">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="jadwal-poster">
                ...
                <div class="poster-date-section">
                    ...
                    <div class="date-day">
                        <?php echo e(\Carbon\Carbon::parse($item->tanggal)->translatedFormat('l')); ?>

                    </div>

                    <div class="date-number">
                        <?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d')); ?>

                    </div>

                    <div class="date-month">
                        <?php echo e(\Carbon\Carbon::parse($item->tanggal)->translatedFormat('F Y')); ?>
                ...
                <div class="poster-main">
                    ...
                    <div class="poster-footer">
                        ...
                        <span>
                            ID #<?php echo e($item->id_jadwal_imam); ?>
                ...
                <div class="poster-actions">
                    ...
                    <a
                        href="<?php echo e(route('jadwal-imam.show', $item->id_jadwal_imam)); ?>"
                    ...
                    <?php if(auth()->user()->role === 'admin'): ?>
                        ...
                        <a
                            href="<?php echo e(route('jadwal-imam.edit', $item->id_jadwal_imam)); ?>"
                        ...
                        <button
                            ...
                            data-bs-target="#deleteModal<?php echo e($item->id_jadwal_imam); ?>"
                            title="Hapus jadwal"
                        >
            ...
            <?php if(auth()->user()->role === 'admin'): ?>
                ...
                <div
                    class="modal fade"
                    id="deleteModal<?php echo e($item->id_jadwal_imam); ?>"
                    tabindex="-1"
                    aria-hidden="true"
                >
                        ...
                        <div class="modal-content delete-modal">
                            ...
                            <div class="modal-body text-center p-4">
                                ...
                                <div class="d-flex gap-2 mt-4">
                                    ...
                                    <form
                                        action="<?php echo e(route('jadwal-imam.destroy', $item->id_jadwal_imam)); ?>"
                                        method="POST"
                                        class="w-50"
                                    >
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="empty-state">
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    ...
                    <a
                        href="<?php echo e(route('jadwal-imam.create')); ?>"
                        class="btn-add"
                    >
                        <i class="fas fa-plus me-2"></i>
                        Tambah Jadwal
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Husen_masjid\resources\views/jadwal-imam/index.blade.php ENDPATH**/ ?>