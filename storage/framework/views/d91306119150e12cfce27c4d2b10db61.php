<footer class="main-footer">
    ...
    <div class="footer-container">
        ...
        <div class="footer-section footer-brand">
            ...
            <div>
                <h5 class="footer-title">
                    <?php echo e($pengaturan->nama_masjid ?? 'Sistem Informasi Masjid'); ?>

                </h5>

                <p class="footer-description">
                    <?php echo e($pengaturan->deskripsi ?? 'Pusat informasi, ibadah, dan kegiatan masjid.'); ?>
        ...
        <div class="footer-section">
            ...
            <?php if($pengaturan && $pengaturan->alamat): ?>
            ...
            <?php if($pengaturan && $pengaturan->no_hp): ?>

                <div class="footer-contact">
                    <i class="fas fa-phone"></i>

                    <span>
                        <?php echo e($pengaturan->no_hp); ?>
            ...
            <?php if($pengaturan && $pengaturan->email): ?>

                <div class="footer-contact">
                    <i class="fas fa-envelope"></i>

                    <span>
                        <?php echo e($pengaturan->email); ?>
...
</style><?php /**PATH E:\Husen_masjid\resources\views/partials/footer.blade.php ENDPATH**/ ?>