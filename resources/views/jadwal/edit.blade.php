                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    type="time"
                                    name="subuh"
                                    value="{{ old('subuh', \Carbon\Carbon::parse($jadwal->subuh)->format('H:i')) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    type="time"
                                    name="dzuhur"
                                    value="{{ old('dzuhur', \Carbon\Carbon::parse($jadwal->dzuhur)->format('H:i')) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    type="time"
                                    name="ashar"
                                    value="{{ old('ashar', \Carbon\Carbon::parse($jadwal->ashar)->format('H:i')) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    type="time"
                                    name="maghrib"
                                    value="{{ old('maghrib', \Carbon\Carbon::parse($jadwal->maghrib)->format('H:i')) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input
                                    type="time"
                                    name="isya"
                                    value="{{ old('isya', \Carbon\Carbon::parse($jadwal->isya)->format('H:i')) }}"
