                    ...
                    <form action="{{ route('pengaturan.update') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="nama_masjid"
                                class="form-control"
                                value="{{ old('nama_masjid', $pengaturan->nama_masjid ?? '') }}"
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <span class="info-value">
                                ...
                                {{ $pengaturan->nama_masjid ?? 'Belum diatur' }}
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <span class="info-value">
                                ...
                                {{ $pengaturan->tahun_berdiri ?? 'Belum diatur' }}
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <span class="info-value">
                                ...
                                {{ $pengaturan->website ?? 'Belum diatur' }}
